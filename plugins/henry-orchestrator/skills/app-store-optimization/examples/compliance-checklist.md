...
Use this checklist before submitting your app to ensure compliance with iOS App Store and Google Play Store policies.
...
- [ ] Religious or cultural content is respectful and informative
...
- [ ] Process to remove objectionable content within 24 hours
...
- [ ] No downloads of executable code
- [ ] Framework/interpreted code properly implemented (React Native, etc.)
...
- [ ] Auto-renewal clearly communicated
...
- [ ] Charity apps from certified nonprofits only
...
- [ ] Apple Music API usage follows guidelines
...
- [ ] No tracking without user permission (iOS 14.5+)
- [ ] App Tracking Transparency implemented if tracking
- [ ] Third-party analytics follow privacy guidelines
...
- [ ] Proof of rights available if requested
...
- [ ] Subscriptions use Google Play Billing
...
- [ ] Subscription management in Play Console
...
- [ ] No network abuse
- [ ] Proxying disclosed if applicable
...
- [ ] Installs and functions properly
- [ ] No broken features
...
- [ ] Moderation system (AI + human recommended)
...
- [ ] Feature graphic represents app
- [ ] Video shows real functionality
...
- [ ] Will update if content changes
...
- [ ] Contacts: Why contacts needed
- [ ] Photos: Purpose of photo access
- [ ] Calendar: Reason for calendar access
...
- [ ] Data Safety form accurate (Android)
...
- [ ] Agreements accepted
- [ ] Tax forms submitted
- [ ] Bank details correct (if monetizing)
...
4. **Guideline 5.1.1** - Privacy policy missing, incomplete, or inaccessible
5. **Guideline 5.1.2** - Data usage not disclosed or no user consent
...
4. **Misleading Content** - App doesn't match description
5. **Inappropriate Ads** - Ads violating policy (interstitial at launch, etc.)
6. **Payments** - Not using Google Play Billing for digital content
...
- [ ] Track ratings
- [ ] Watch for policy update emails
...
5. Update Review Notes with explanation
6. Resubmit
7. Use Resolution Center if needed (iOS)
8. Appeal if rejection unclear or incorrect
...
4. Metadata accurate and not misleading
5. App fully functional with no placeholder content
6. Correct payment implementation
7. Content rights secured
8. Age rating appropriate
9. No policy violations
10. Demo account working (if login required)

**Complete these checks before every submission to maximize approval chances.**
