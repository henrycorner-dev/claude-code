...
### For Godot:
- Create the project directory structure
- Set up `.gitignore` for Godot projects (.import/, export/, *.translation, .mono/, data_*/)
...
### For Unreal Engine:
- Create the project directory structure
- Set up `.gitignore` for Unreal projects (Binaries/, DerivedDataCache/, Intermediate/, Saved/, *.sln, *.suo, etc.)
