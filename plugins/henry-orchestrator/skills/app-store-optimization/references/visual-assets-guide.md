# Visual Assets Guide for App Store Optimization

This document provides detailed specifications, best practices, and design strategies for app store visual assets.
...
- Actual displayed sizes: 48x48dp to 192x192dp
...
4. **Scalability** - Clear at all sizes
...
- Limit to 2-3 colors
- Avoid text (if necessary, keep minimal)
- Center the primary element
- Avoid detailed imagery
- Consider cultural meanings of colors/symbols
...
- **Health/Fitness:** Active, motivational
- **Finance:** Trust signals, professional
- **Education:** Friendly, accessible
...
- Supported sizes (must provide for at least one device):
  - iPhone 6.7": 1290x2796 px (portrait) or 2796x1290 (landscape)
  - iPhone 6.5": 1242x2688 px (portrait) or 2688x1242 (landscape)
  - iPhone 5.5": 1242x2208 px (portrait) or 2208x1242 (landscape)
  - iPad Pro (12.9", 6th gen): 2048x2732 px (portrait) or 2732x2048 (landscape)
  - iPad Pro (12.9", 2nd gen): 2048x2732 px (portrait) or 2732x2048 (landscape)
- Format: JPEG or PNG
- Color space: RGB
...
- Dimensions:
  ...
  - Recommended: 1080x1920 px (portrait) or 1920x1080 (landscape)
- Format: PNG or JPEG
- 16:9 or 9:16 aspect ratio works best
...
- Remove status bar (cleaner look) or use clean mockups
...
- Most users won't scroll past first 2-3
...
4. Features that enable benefits
5. Social proof
...
- Good for: Games, creative apps, unique concepts
...
- Placement: Top or bottom third (avoid center where UI is)
- Hierarchy: Large headline, optional smaller supporting text
- Consistency: Same typography across all screenshots
...
- Ignoring local competitors' approaches
...
- Formats: .mov, .mp4, .m4v
- Codecs: H.264, ProRes 422
- Resolutions (same as screenshot sizes):
  - iPhone 6.7": 886x1920 px to 1080x1920 px
  - iPhone 6.5": 886x1920 px to 1080x1920 px
  - iPad Pro (12.9"): 1200x1600 px to 1600x1200 px
...
- Annotations/highlights to guide viewer
...
- Device mockups: Rotato, Mockuuups
...
- Does it highlight key benefits?
...
4. Apply to remaining screenshots
...
- Poor conversion rate (test new approaches)
- Seasonal campaigns (temporary updates)
...
- [ ] Font supports language characters
- [ ] Imagery culturally relevant
- [ ] Native speaker approval
- [ ] Tested in target market
...
- FFmpeg (advanced video encoding)
...
- Screenshot engagement (if available)
...
6. Implement: Apply winning variant
...
- Video vs. no video
- Various screenshot quantities (2-5 vs. full 10)
